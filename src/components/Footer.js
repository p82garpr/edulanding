        ...
        <div className="footer-top">
          ...
          <div className="footer-section footer-contact">
            ...
            <div className="contact-info">
              ...
              <div className="contact-item">
                <span className="contact-icon">🎓</span>
                <span>TFG Ingeniería Informática</span>
              </div>
              <div className="contact-item">
                <span className="contact-icon">🏫</span>
            ...
            <div className="social-links">
              <a href="https://github.com/p82garpr/eduCode.AI" className="social-link github" aria-label="GitHub">
              ...
              <a href="https://www.linkedin.com/in/rafael-garcía-pérez-90b915202/" className="social-link linkedin" aria-label="LinkedIn">
                <svg viewBox="0 0 24 24" fill="currentColor">
